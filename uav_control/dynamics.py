...
from uav_control.constants import (a_g_N, compose_state, compose_state_dot,
                                   decompose_state, e3_B, g, thrust_axis_B)
...
class QuadrotorRigidBodyDynamics(ContinuousTimeModel):
    ...
    def continuous_dynamics(self, t: float, y: np.ndarray) -> np.ndarray:
        ...
        ydot = compose_state_dot(
            ...
            omega_b0_B_dot=self.compute_omega_b0_B_dot(
                decomposed_state, allocated_torque_B
            ),
        )
